...
WORKDIR /app
LABEL org.opencontainers.image.source="https://github.com/Opus-Perpetuus/imperium-subject-tableros-dinamicos"
LABEL org.opencontainers.image.url="https://github.com/Opus-Perpetuus/imperium-subject-tableros-dinamicos"
...
COPY src ./src
ENV PORT=3000 \
    SUBJECT_TECHNICAL_ID=subject-tableros-dinamicos \
    KIRLET_TECHNICAL_ID=subject-tableros-dinamicos \
    DATA_DIR=/data \
    SUBJECT_AUTH=on \
    KIRLET_AUTH=on
